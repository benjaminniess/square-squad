 ...
 */
const Press = require('../../lib/obstacles/press')
const Ball = require('../../lib/obstacles/ball')
const SimpleHole = require('../../lib/obstacles/simple-hole')
const SpaceInvaders = require('../../lib/obstacles/space-invaders')
