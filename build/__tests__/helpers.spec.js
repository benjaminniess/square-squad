...
describe('stringToSlug function', () => {
    ...
    it('returns a slug from a string with numbers', () => {
        expect(helpers.stringToSlug('The string vAlue 123456')).toBe('the-string-value-123456');
    });
    it('returns a slug from a string with numbers and special characters', () => {
        expect(helpers.stringToSlug('Thé string"@vAlue+123456')).toBe('the-stringvalue123456');
    });
});
