                    ...
                    if (game.getType() === 'countdown') {
                        ...
                        let gameTimer = setInterval(function () {
                            ...
                            if (countAlive === 0 ||
                                ...
                                clearInterval(gameTimer);
                                if (countAlive) {
                                    _.forEach(playersManager.getPlayersData(), (playerData, playerID) => {
                                        if (playerData.alive) {
