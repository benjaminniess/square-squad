...
class SimpleHole extends Obstacle {
    ...
    init() {
        ...
        let obstacleSpot = helpers.getRandomInt(squareSize, canvasWidth - squareSize);
        let obstacle = {};
        let obstacleParts = [];
        switch (direction) {
            case 1:
        ...
        _.forEach(obstacleParts, (obstaclePart) => {
            let body = Matter.Bodies.rectangle(obstaclePart.x, obstaclePart.y, obstaclePart.width, obstaclePart.height, {
                frictionAir: 0,
